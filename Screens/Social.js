...
export default function Social({navigation}) {
    ...
    const [isSocialLoading, setSocialLoading] = useState(true);
    ...
    return (
      <SafeAreaView style={{ flex: 1 }}>
        {isSocialLoading ? <View style={styles.activityContainer}><ActivityIndicator size="large" color="#007cba" /><Text style={styles.isloading}>Κάτι νέο έρχεται...</Text></View> : 
